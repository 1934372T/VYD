# オブジェクト指向分析
- [ドメインモデル図](#ドメインモデル図)
- [ユースケース図：発表情報を登録する](#ユースケース発表情報を登録する)
  - [ロバストネス図](#ロバストネス図-登録)
  - [シーケンス図](#シーケンス図-登録)
- [ユースケース図：発表情報を閲覧する](#ユースケース発表情報を閲覧する)
  - [ロバストネス図](#ロバストネス図-閲覧)
  - [シーケンス図](#シーケンス図-閲覧)
...
### シーケンス図 (閲覧)
![シーケンス図 drawio](https://github.com/1934372T/VYD/assets/100588602/d1c8e7ab-9274-47fa-ba5b-fa5f686812d0)
